...
# This code is a bit inefficient as it doesn't pair the files in script 4 - may want to sort this out, but its not really an issue (not with <10 of files, but probably fine with 10s)
...
## Runs on base...
## Maybe include fbox and pranc domain annotations?