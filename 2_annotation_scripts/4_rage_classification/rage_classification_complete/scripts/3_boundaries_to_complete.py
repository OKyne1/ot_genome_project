...
if __name__ == "__main__":
 ...
 # tran and trah processing approaches are redundant when complete is included   
    # Example usage with dictionary data
    tra_genes = ['complete traa', 'complete trab', 'complete trac', 'complete trad', 'complete trae', 'complete traf', 'complete trag', 'complete trai', 'complete trak', 'complete tral', 'complete tran', 'complete trau', 'complete trav', 'complete traw']
