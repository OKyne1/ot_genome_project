...
def check_files_for_strings(file_data, tra_genes, tran, trah, transposase, cargo):
    ...
    for file_key, file_content in file_data.items():
        ...
        if all_tra_genes_present and tran_present and trah_present and transposase_present and cargo_present and specific_string_count >= specific_count_required:
...
# This currently doesn't require complete integrases and it probably should - need to investigate this.
