# Plot generation method for multiple genomes at once
...
# 4. Rename genomes, these are the names which will be on the plot
#
...
# 2. Use the paf file in this script generated by the code above.
#
...
# - If names are changed in the files, the bedfiles will need to be changed as well
#
...
# This is done using 1_bed_inverse.py and 2_IR_only_bed_conversion.py to convert the bed files --> this isn't very well annotated, give chatgpt the code and ask how it works.
#
